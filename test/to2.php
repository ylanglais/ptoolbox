...
$tns="(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=orarec-19.lfm.lan) (PORT=1521)) (CONNECT_DATA=(SERVICE_NAME=rflorec)))";
...
if (($cn = oci_connect($db_username, $db_password, $tns)) === false) {
